...
public class KeysFetchTests
{
    ...
    {
        var auth = KeysFetchAuth.Create(Id("alice"), new Address("bob", "gateway"), requestedAt: Now);
    ...
    public void A_signature_over_the_right_fields_but_a_DIFFERENT_ident_pub_is_rejected()
    {
        ...
        var real = KeysFetchAuth.Create(Id("alice"), new Address("bob", "gateway"), requestedAt: Now);
