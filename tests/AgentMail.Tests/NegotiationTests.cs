...
/// cases and the outbound fail-closed-no-block posture, including Wolf's clean-partition scenario.
/// </summary>
public class NegotiationTests
{
    ...
    {
        // FLAG-38 (b): grace elapsing is convergence evidence on its own. This is also Wolf's partitioned-peer
